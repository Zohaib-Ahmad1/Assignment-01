...
for (let i = 0; i <pizza.length; i++)
{
    ...
    if (pizza[i].length)
    {
        console.log(`My favourite falvor is ${pizza[i]} pizza\n`)
    }
}
console.log("When I was wotking in field, I had pizza almost twice in a month. Usually we throw parties and Pizza was mendatory")